...
from vg.defn.encoders import TextEncoder, SpeechEncoder, ImageEncoder
...
class Net(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.Text = Text(self.SpeechEncoder, config['Text'])  
        self.Image = Image(self.SpeechEncoder, config['Image'])
...
## Need to take care of having two datasets here
